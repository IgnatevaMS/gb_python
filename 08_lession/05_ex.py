...
class Storage:
    ...
    def __str__(self):
        return f"На складе сейчас {len(self.__storage)} устройств/а"
...
if __name__ == '__main__':
    storage = Storage()
    storage.add(Printer("HP", "LaserJet2000"))
    storage.add(Scanner("Ericsson", "MFX500"))
    ...
    storage.transfer(last_idx, 'Отдел Бухгалтерии')
